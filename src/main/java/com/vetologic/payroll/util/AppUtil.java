...
public class AppUtil {
	...
	public static String previousMonthIn3Words() {
		Calendar cal = Calendar.getInstance();
		cal.add(Calendar.MONTH, -1);
		String previousMonthInWords = new SimpleDateFormat("MMM").format(cal.getTime());
	...
	public static String prevMonthInWordsWithDate(String taskDueDate) {
		Calendar cal = Calendar.getInstance();
		Date date = null;
		try {
			date = new SimpleDateFormat("dd-MM-yyyy").parse(taskDueDate);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		cal.setTime(date);
		cal.add(Calendar.MONTH, -2);
		String monthInWords = new SimpleDateFormat("MMM").format(cal.getTime());
		return monthInWords;
	}
	...
	public static String financialYearWithDueDate(String taskDueDate) {
		Date date = null;
		try {
			date = new SimpleDateFormat("dd-MM-yyyy").parse(taskDueDate);
		} catch (ParseException e) {
		...
		String yearWithDate = new SimpleDateFormat("yyyy").format(date);
		String monthInDigit = new SimpleDateFormat("MM").format(date);
		int month = Integer.parseInt(monthInDigit) - 2;
		String dateInStr = String.valueOf(month) + "-" + yearWithDate;
		DateFormat df = new SimpleDateFormat("MM-yyyy");
		java.util.Calendar cal = java.util.Calendar.getInstance();
		try {
			cal.setTime(df.parse(dateInStr));
	...
	public static String prevMonthFinancialYear() {
		int year = java.util.Calendar.getInstance().get(java.util.Calendar.YEAR);
		String yearInString = String.valueOf(year);
		int prevMonth = java.util.Calendar.getInstance().get(java.util.Calendar.MONTH);  
        String date = String.valueOf(prevMonth)+"-"+yearInString;
        DateFormat df = new SimpleDateFormat("MM-yyyy");
        java.util.Calendar cal  = java.util.Calendar.getInstance();
	    try {
			cal.setTime(df.parse(date));
	...
	public static String changeDateFormatToClashs(String mydate) {
		Date date = null;
		try {
			date = new SimpleDateFormat("dd-MMM-yyyy").parse(mydate);
		} catch (ParseException e) {
			e.printStackTrace();
		}
		String dateFormat = new SimpleDateFormat("dd/MM/yyyy").format(date);
